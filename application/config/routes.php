...
$route['404_override'] = 'Error_Controller/notFound';
$route['translate_uri_dashes'] = FALSE;
$route['landingPage/(:any)/(:any)'] = 'landingPage/coba/$1/$2';

$route['post-page'] = 'Master_Controller/postPage';
$route['post'] = 'Master_Controller/post';
